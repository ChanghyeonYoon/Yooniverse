  ...
  return (
    <>
      <motion.button
        ...
        className='rounded-3xl bg-gray-100 dark:bg-neutral-900 h-80 w-56 md:h-[40rem] md:w-[30rem] overflow-hidden flex flex-col items-start justify-start relative z-10'
      >
